...
@pytest.fixture
def asia_sampling():
    asia_dag = bn.import_DAG('sprinkler')
...
def test_filtering_no_filter(asia_sampling):
    ...
    assert set(model['adjmat'].columns.values) == {'Cloudy', 'Sprinkler', 'Rain', 'Wet_Grass'}


# def test_hc_white_list_nodes(asia_sampling):
#     model = bn.structure_learning.fit(asia_sampling, methodtype='hc', white_list=['smoke', 'either'], bw_list_method='nodes')
#     assert set(model['adjmat'].columns) == {'smoke', 'either'}


# def test_hc_white_list_edges(asia_sampling):
#     model = bn.structure_learning.fit(asia_sampling, methodtype='hc', white_list=['smoke', 'either'], bw_list_method='edges')
#     assert set(model['adjmat'].columns) == {'smoke', 'bronc', 'lung', 'asia', 'tub', 'either', 'dysp', 'xray'}


# def test_hc_black_list_nodes(asia_sampling):
#     model = bn.structure_learning.fit(asia_sampling, methodtype='hc', black_list=['smoke', 'either'], bw_list_method='nodes')
#     assert set(model['adjmat'].columns) == {'bronc', 'lung', 'asia', 'tub', 'dysp', 'xray'}


# def test_hc_black_list_edges(asia_sampling):
#     model = bn.structure_learning.fit(asia_sampling, methodtype='hc', scoretype='bic', black_list=['smoke', 'either'], bw_list_method='edges')
    # assert set(model['adjmat'].columns) == {'smoke', 'bronc', 'lung', 'asia', 'tub', 'either', 'dysp', 'xray'}


# def test_ex_white_list_nodes(asia_sampling):
#     model = bn.structure_learning.fit(asia_sampling, methodtype='ex', white_list=['smoke', 'either'], bw_list_method='nodes')
#     assert set(model['adjmat'].columns) == {'either', 'smoke'}


# def test_ex_black_list_nodes(asia_sampling):
#     model = bn.structure_learning.fit(asia_sampling, methodtype='ex', black_list=['asia', 'tub', 'either', 'dysp', 'xray'], bw_list_method='nodes')
